...
<body>
  ...
  <main>
    <section class="container-banner">
      ...
      <div class="box-img-banner">
        <img src="./src/assets/Group 1.png" alt="Foto de famosos que fazem show" class="img-banner">
      </div>
    </section>
    <section class="container-blocks-informations">

      <div class="box-information">
        <img src="./src/assets/security.svg" alt="escudo Segurança">
        <h3>Segurança</h3>
      ...
      <div class="box-information">
        <img src="./src/assets/People.svg" alt="Pessoas Equipe">
        <h3>Equipe</h3>
        <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
        <button>Mais informações</button>
      </div>
      ...
      <div class="box-information">
        <img src="./src/assets/carrinho.svg" alt="Carrinho Vendas">
        <h3>Vendas</h3>
        <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
        <button>Mais informações</button>
      </div>
    ...
    <section class="container-next-event">
      ...
      <div class="box-next-event">
        <div class="box-imgs-next-events">
          ...
          <img src="./src/assets/brunomars.png" alt="Bruno Mars show" class="img1">
          <img src="./src/assets/chrisbrown.png" alt="Chris Brownl" class="img2">
          <img src="./src/assets/shakira.png" alt="Shakira" class="img2">
        </div>
    ...
    <section class="container-information-principais">
      <div class="block-information-principais">
        <div class="block-img-information-principais">
          <img src="./src/assets/img1.png" alt="show">
        </div>
      ...
      <div class="block-information-principais">
        ...
        <div class="block-img-information-principais">
          <img src="./src/assets/img2.png" alt="show">
        </div>
      </div>
      <div class="block-information-principais">
        <div class="block-img-information-principais">
          <img src="./src/assets/img3.png" alt="show">
        </div>
        <div class="block-text-information-principais">
          <h3>Nossa equipe</h3>
          <p>
      ...
      <div class="block-information-principais">
        ...
        <div class="block-img-information-principais">
          <img src="./src/assets/img4.png" alt="show">
        </div>
      </div>
  ...
  <footer class="container-footer">
    ...
    <div><img src="./src/assets/Eventify.png" alt="Logo marca"></div>
